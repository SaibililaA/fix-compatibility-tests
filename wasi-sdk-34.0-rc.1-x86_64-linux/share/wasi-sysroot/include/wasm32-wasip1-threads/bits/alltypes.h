...
typedef struct { int _m_type; int _m_lock; int _m_count; struct __waitlist_node *_m_waiters; } pthread_mutex_t;
#define __DEFINED_pthread_mutex_t
#endif

#if defined(__NEED_mtx_t) && !defined(__DEFINED_mtx_t)
typedef struct { int _m_type; int _m_lock; int _m_count; struct __waitlist_node *_m_waiters; } mtx_t;
#define __DEFINED_mtx_t
#endif

#if defined(__NEED_pthread_cond_t) && !defined(__DEFINED_pthread_cond_t)
typedef struct { struct __waitlist_node *_c_waiters; } pthread_cond_t;
#define __DEFINED_pthread_cond_t
#endif

#if defined(__NEED_cnd_t) && !defined(__DEFINED_cnd_t)
typedef struct { struct __waitlist_node *_c_waiters; } cnd_t;
#define __DEFINED_cnd_t
#endif

#if defined(__NEED_pthread_rwlock_t) && !defined(__DEFINED_pthread_rwlock_t)
typedef struct { long long _rw_lock; struct __waitlist_node *_rw_waiters; } pthread_rwlock_t;
#define __DEFINED_pthread_rwlock_t
#endif

#if defined(__NEED_pthread_barrier_t) && !defined(__DEFINED_pthread_barrier_t)
typedef struct { int _b_limit; int _b_count; struct __waitlist_node *_b_waiters; } pthread_barrier_t;
