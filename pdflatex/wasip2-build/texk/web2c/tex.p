...
{:300}{548:}internalfontnumber=integer;fontindex=integer;
ninebits=0..256;{:548}{594:}dviindex=0..dvibufsize;
{:594}{920:}triepointer=0..4194303;trieopcode=0..65535;
{:920}{925:}hyphpointer=0..65535;{:925}var{13:}bad:integer;
...
texremainder:scaled;{:104}{115:}tempptr:halfword;
{:115}{116:}yzmem:^memoryword;zmem:^memoryword;lomemmax:halfword;
...
{:213}{246:}oldsetting:0..21;systime,sysday,sysmonth,sysyear:integer;
{:246}{253:}zeqtb:^memoryword;
...
{:513}{520:}formatdefaultlength:integer;TEXformatdefault:cstring;
{:520}{527:}nameinprogress:boolean;jobname:strnumber;logopened:boolean;
{:527}{532:}dvifile:bytefile;outputfilename:strnumber;
texmflogname:strnumber;{:532}{539:}tfmfile:bytefile;
{:539}{549:}fontinfo:^fmemoryword;fmemptr:fontindex;
...
fontfalsebchar:^ninebits;{:549}{550:}charbase:^integer;
...
lq,lr:integer;{:592}{595:}dvibuf:^eightbits;halfbuf:integer;
...
{:907}{921:}trietrl:^triepointer;trietro:^triepointer;
...
{:921}{926:}hyphword:^strnumber;hyphlist:^halfword;
hyphlink:^hyphpointer;hyphcount:integer;hyphnext:integer;
{:926}{943:}ifdef('INITEX')trieophash:array[negtrieopsize..trieopsize]of
...
{:943}{947:}ifdef('INITEX')triec:^packedASCIIcode;trieo:^trieopcode;
triel:^triepointer;trier:^triepointer;trieptr:triepointer;
triehash:^triepointer;
endif('INITEX'){:947}{950:}ifdef('INITEX')trietaken:^boolean;
triemin:array[ASCIIcode]of triepointer;triemax:triepointer;
trienotready:boolean;
endif('INITEX'){:950}{971:}bestheightplusdepth:scaled;
...
{:1345}{1379:}editnamestart:poolpointer;editnamelength,editline:integer;
ipcon:cinttype;stopatspace:boolean;{:1379}{1381:}savestrptr:strnumber;
...
{:1383}{1390:}expanddepthcount:integer;{:1390}{1393:}mltexp:boolean;
{:1393}{1394:}mltexenabledp:boolean;
...
var{19:}i:integer;{:19}{163:}k:integer;{:163}{927:}z:hyphpointer;
{:927}begin{8:}{21:}xchr[32]:=' ';xchr[33]:='!';xchr[34]:='"';
...
{:272}{287:}magset:=0;{:287}{383:}curmark[0]:=-268435455;
curmark[1]:=-268435455;curmark[2]:=-268435455;curmark[3]:=-268435455;
curmark[4]:=-268435455;{:383}{439:}curval:=0;curvallevel:=0;radix:=0;
curorder:=0;{:439}{481:}for k:=0 to 16 do readopen[k]:=2;
{:481}{490:}condptr:=-268435455;iflimit:=0;curif:=0;ifline:=0;
{:490}{551:}{:551}{556:}nullcharacter.b0:=0;nullcharacter.b1:=0;
nullcharacter.b2:=0;nullcharacter.b3:=0;{:556}{593:}totalpages:=0;
...
{:596}{606:}downptr:=-268435455;rightptr:=-268435455;
{:606}{648:}adjusttail:=-268435455;lastbadness:=0;
...
{:685}{771:}alignptr:=-268435455;curalign:=-268435455;
curspan:=-268435455;curloop:=-268435455;curhead:=-268435455;
curtail:=-268435455;
{:771}{928:}for z:=0 to hyphsize do begin hyphword[z]:=0;
...
{:1343}{1380:}editnamestart:=0;stopatspace:=true;haltingonerrorp:=false;
{:1380}{1391:}expanddepthcount:=0;{:1391}{1395:}mltexenabledp:=false;
{:1395}{1408:}enctexenabledp:=false;
...
{790:}mem[memtop-10].hh.lh:=19614;{:790}{797:}mem[memtop-9].hh.rh:=256;
mem[memtop-9].hh.lh:=-268435455;{:797}{820:}mem[memtop-7].hh.b0:=1;
mem[memtop-6].hh.lh:=268435455;mem[memtop-7].hh.b1:=0;
{:820}{981:}mem[memtop].hh.b1:=255;mem[memtop].hh.b0:=1;
mem[memtop].hh.rh:=memtop;{:981}{988:}mem[memtop-2].hh.b0:=10;
mem[memtop-2].hh.b1:=0;{:988};avail:=-268435455;memend:=memtop;
...
{:258}{552:}{:552}{946:}for k:=-trieopsize to trieopsize do trieophash[k
]:=0;for k:=0 to 255 do trieused[k]:=mintrieop;maxopused:=mintrieop;
trieopptr:=0;{:946}{951:}trienotready:=true;
{:951}{1216:}hash[15514].rh:=1209;
{:1216}{1301:}if iniversion then formatident:=1289;
{:1301}{1369:}hash[15522].rh:=1331;eqtb[15522].hh.b1:=1;
eqtb[15522].hh.b0:=113;eqtb[15522].hh.rh:=-268435455;{:1369}end;
...
{:263}{518:}procedure printfilename(n,a,e:integer);
...
printesc(419);end;{:699}{1355:}procedure printwritewhatsit(s:strnumber;
...
{:1355}{1382:}procedure printcsnames(hstart:integer;hfinish:integer);
var c,h:integer;
...
{:1382}{1384:}procedure printfileline;var level:0..maxinopen;
begin level:=inopen;
...
print(581);end;end;
{:1384}{1409:}function readbuffer(var i:integer):ASCIIcode;
...
printnl(266);printnl(267);
if baseptr>0 then if inputstack[baseptr].namefield>=256 then print(268);
...
{:46}{47:}{1388:}function searchstring(search:strnumber):strnumber;
...
{:1388}{1389:}function slowmakestring:strnumber;label 10;
...
{:1389}ifdef('INITEX')function getstringsstarted:boolean;label 30,10;
...
fatalerror(261);end;termoffset:=0;decr(selector);k:=first;
while k<last do begin printbuffer(k)end;println;incr(selector);end;
{:71}{91:}procedure interror(n:integer);begin print(284);printint(n);
...
{933:}for q:=0 to hyphsize do begin if hyphlist[q]=p then begin printnl(
959);printint(q);printchar(41);end;end{:933};end;
...
print(879);end else showinfo;others:end;decr(poolptr);end;end;
{:692}{694:}procedure printstyle(c:integer);
begin case c div 2 of 0:printesc(880);1:printesc(881);2:printesc(882);
3:printesc(883);others:print(884)end;end;
...
printmark(mem[p+1].hh.rh);end;4:begin printesc(1324);
printint(mem[p+1].hh.rh);print(1327);printint(mem[p+1].hh.b0);
printchar(44);printint(mem[p+1].hh.b1);printchar(41);end;
others:print(1328)end{:1356};
...
end{:197};{690:}14:printstyle(mem[p].hh.b1);
15:{695:}begin printesc(538);begin strpool[poolptr]:=68;incr(poolptr);
...
shownodelist(mem[p+2].hh.rh);decr(poolptr);end{:695};
16,17,18,19,20,21,22,23,24,27,26,29,28,30,31:{696:}begin case mem[p].hh.
b0 of 16:printesc(885);17:printesc(886);18:printesc(887);
19:printesc(888);20:printesc(889);21:printesc(890);22:printesc(891);
23:printesc(892);27:printesc(893);26:printesc(894);29:printesc(552);
24:begin printesc(546);printdelimiter(p+4);end;28:begin printesc(520);
printfamandchar(p+4);end;30:begin printesc(895);printdelimiter(p+1);end;
31:begin printesc(896);printdelimiter(p+1);end;end;
if mem[p].hh.b1<>0 then if mem[p].hh.b1=1 then printesc(897)else
printesc(898);if mem[p].hh.b0<30 then printsubsidiarydata(p+1,46);
printsubsidiarydata(p+2,94);printsubsidiarydata(p+3,95);end{:696};
25:{697:}begin printesc(899);
if mem[p+1].int=1073741824 then print(900)else printscaled(mem[p+1].int)
;
if(mem[p+4].qqqq.b0<>0)or(mem[p+4].qqqq.b1<>0)or(mem[p+4].qqqq.b2<>0)or(
mem[p+4].qqqq.b3<>0)then begin print(901);printdelimiter(p+4);end;
if(mem[p+5].qqqq.b0<>0)or(mem[p+5].qqqq.b1<>0)or(mem[p+5].qqqq.b2<>0)or(
mem[p+5].qqqq.b3<>0)then begin print(902);printdelimiter(p+5);end;
printsubsidiarydata(p+2,92);printsubsidiarydata(p+3,47);end{:697};
{:690}others:print(315)end{:183};p:=mem[p].hh.rh;end;10:end;
...
2,4:freenode(p,2);others:confusion(1330)end;goto 30;end{:1358};
...
{:698}others:confusion(350)end;freenode(p,2);30:end;p:=q;end;end;
...
2,4:begin r:=getnode(2);words:=2;end;others:confusion(1329)end{:1357};
...
if p=0 then begin{986:}if memtop-2<>pagetail then begin printnl(999);
if outputactive then print(1000);showbox(mem[memtop-2].hh.rh);
if pagecontents>0 then begin printnl(1001);printtotals;printnl(1002);
printscaled(pagesofar[0]);r:=mem[memtop].hh.rh;
while r<>memtop do begin println;printesc(327);t:=mem[r].hh.b1;
printint(t);print(1003);
...
until q=mem[r+1].hh.lh;print(1004);printint(t);print(1005);end;
...
end;{:237}{241:}procedure fixdateandtime;
begin dateandtime(systime,sysday,sysmonth,sysyear);
eqtb[27187].int:=systime;eqtb[27188].int:=sysday;
eqtb[27189].int:=sysmonth;eqtb[27190].int:=sysyear;end;
{:241}{245:}procedure begindiagnostic;begin oldsetting:=selector;
...
{:335}{377:}104:if chrcode=0 then printesc(644)else printesc(645);
{:377}{385:}110:case chrcode of 1:printesc(647);2:printesc(648);
3:printesc(649);4:printesc(650);others:printesc(646)end;
{:385}{412:}89:if chrcode=0 then printesc(488)else if chrcode=1 then
printesc(512)else if chrcode=2 then printesc(400)else printesc(401);
{:412}{417:}79:if chrcode=1 then printesc(684)else printesc(683);
...
{:417}{469:}108:case chrcode of 0:printesc(750);1:printesc(751);
2:printesc(752);3:printesc(753);4:printesc(754);others:printesc(755)end;
{:469}{488:}105:case chrcode of 1:printesc(773);2:printesc(774);
3:printesc(775);4:printesc(776);5:printesc(777);6:printesc(778);
7:printesc(779);8:printesc(780);9:printesc(781);10:printesc(782);
11:printesc(783);12:printesc(784);13:printesc(785);14:printesc(786);
15:printesc(787);16:printesc(788);others:printesc(772)end;
{:488}{492:}106:if chrcode=2 then printesc(789)else if chrcode=4 then
printesc(790)else printesc(791);
{:492}{781:}4:if chrcode=256 then printesc(917)else begin print(921);
print(chrcode);end;
5:if chrcode=257 then printesc(918)else printesc(919);
{:781}{984:}81:case chrcode of 0:printesc(989);1:printesc(990);
2:printesc(991);3:printesc(992);4:printesc(993);5:printesc(994);
6:printesc(995);others:printesc(996)end;
{:984}{1053:}14:if chrcode=1 then printesc(1044)else printesc(1043);
{:1053}{1059:}26:case chrcode of 4:printesc(1045);0:printesc(1046);
1:printesc(1047);2:printesc(1048);others:printesc(1049)end;
27:case chrcode of 4:printesc(1050);0:printesc(1051);1:printesc(1052);
2:printesc(1053);others:printesc(1054)end;28:printesc(333);
29:printesc(337);30:printesc(339);
{:1059}{1072:}21:if chrcode=1 then printesc(1072)else printesc(1073);
22:if chrcode=1 then printesc(1074)else printesc(1075);
20:case chrcode of 0:printesc(414);1:printesc(1076);2:printesc(1077);
3:printesc(984);4:printesc(1078);5:printesc(986);
others:printesc(1079)end;
31:if chrcode=100 then printesc(1081)else if chrcode=101 then printesc(
1082)else if chrcode=102 then printesc(1083)else printesc(1080);
{:1072}{1089:}43:if chrcode=0 then printesc(1099)else printesc(1098);
{:1089}{1108:}25:if chrcode=10 then printesc(1110)else if chrcode=11
then printesc(1109)else printesc(1108);
23:if chrcode=1 then printesc(1112)else printesc(1111);
24:if chrcode=1 then printesc(1114)else printesc(1113);
{:1108}{1115:}47:if chrcode=1 then printesc(45)else printesc(346);
{:1115}{1143:}48:if chrcode=1 then printesc(1147)else printesc(1146);
{:1143}{1157:}50:case chrcode of 16:printesc(885);17:printesc(886);
18:printesc(887);19:printesc(888);20:printesc(889);21:printesc(890);
22:printesc(891);23:printesc(892);26:printesc(894);
others:printesc(893)end;
51:if chrcode=1 then printesc(897)else if chrcode=2 then printesc(898)
else printesc(1148);{:1157}{1170:}53:printstyle(chrcode);
{:1170}{1179:}52:case chrcode of 1:printesc(1167);2:printesc(1168);
3:printesc(1169);4:printesc(1170);5:printesc(1171);
others:printesc(1166)end;
{:1179}{1189:}49:if chrcode=30 then printesc(895)else printesc(896);
{:1189}{1209:}93:if chrcode=1 then printesc(1190)else if chrcode=2 then
printesc(1191)else printesc(1192);
97:if chrcode=0 then printesc(1193)else if chrcode=1 then printesc(1194)
else if chrcode=2 then printesc(1195)else printesc(1196);
{:1209}{1220:}94:if chrcode<>0 then if chrcode=10 then printesc(1212)
else if chrcode=11 then printesc(1213)else printesc(1211)else printesc(
1210);{:1220}{1223:}95:case chrcode of 0:printesc(1219);
1:printesc(1220);2:printesc(1221);3:printesc(1222);4:printesc(1223);
5:printesc(1224);7:printesc(1226);others:printesc(1225)end;
68:begin printesc(525);printhex(chrcode);end;69:begin printesc(537);
printhex(chrcode);end;
{:1223}{1231:}85:if chrcode=25580 then printesc(1231)else if chrcode=
25581 then printesc(1232)else if chrcode=25582 then printesc(1233)else
...
{:1231}{1251:}99:if chrcode=1 then printesc(972)else printesc(960);
{:1251}{1255:}78:if chrcode=0 then printesc(1249)else printesc(1250);
{:1255}{1261:}87:begin print(1258);slowprint(fontname[chrcode]);
if fontsize[chrcode]<>fontdsize[chrcode]then begin print(756);
printscaled(fontsize[chrcode]);print(402);end;end;
{:1261}{1263:}100:case chrcode of 0:printesc(272);1:printesc(273);
2:printesc(274);others:printesc(1259)end;
{:1263}{1273:}60:if chrcode=0 then printesc(1261)else printesc(1260);
{:1273}{1278:}58:if chrcode=0 then printesc(1262)else printesc(1263);
{:1278}{1287:}57:if chrcode=25887 then printesc(1269)else printesc(1270)
;{:1287}{1292:}19:case chrcode of 1:printesc(1272);2:printesc(1273);
3:printesc(1274);others:printesc(1271)end;{:1292}{1295:}101:print(1281);
111:print(1282);112:printesc(1283);113:printesc(1284);
114:begin printesc(1190);printesc(1284);end;115:printesc(1285);
{:1295}{1346:}59:case chrcode of 0:printesc(1320);1:printesc(606);
2:printesc(1321);3:printesc(1322);4:printesc(1323);5:printesc(1324);
others:print(1325)end;{:1346}others:print(580)end;end;
...
if eqtb[27197].int>0 then{401:}begin begindiagnostic;println;
...
then decr(alignstate);goto 40;end else goto 22;end{:394};
{397:}if s<>r then if s=-268435455 then{398:}begin begin if interaction=
...
40:if s<>-268435455 then{400:}begin if(m=1)and(mem[p].hh.lh<768)then
...
{390:}while(curinput.statefield=0)and(curinput.locfield=-268435455)and(
...
if curcmd<111 then{367:}begin if eqtb[27203].int>1 then showcurcmdchr;
case curcmd of 110:{386:}begin if curmark[curchr]<>-268435455 then
begintokenlist(curmark[curchr],14);end{:386};102:{368:}begin gettoken;
t:=curtok;gettoken;if curcmd>100 then expand else backinput;curtok:=t;
backinput;end{:368};103:{369:}begin savescannerstatus:=scannerstatus;
...
curinput.startfield:=p;curinput.locfield:=p;end;end{:369};
107:{372:}begin r:=getavail;p:=r;repeat getxtoken;
if curcs=0 then begin q:=getavail;mem[p].hh.rh:=q;mem[q].hh.lh:=curtok;
p:=q;end;until curcs<>0;
if(curcmd<>67)or(curchr<>0)then{373:}begin begin if interaction=3 then;
...
helpline[0]:=643;end;backerror;end{:373};{374:}j:=first;p:=mem[r].hh.rh;
...
end;printcmdchr(106,curchr);begin helpptr:=1;helpline[0]:=793;end;error;
...
others:{370:}begin begin if interaction=3 then;
...
helpline[1]:=638;helpline[0]:=639;end;error;end{:370}end;
end{:367}else if curcmd<115 then macrocall else{375:}begin curtok:=19615
...
{:408}{409:}procedure scanint;forward;{433:}procedure scaneightbitint;
begin scanint;
...
interror(curval);curval:=0;end;end;
{:437}{1385:}procedure scanfourbitintor18;begin scanint;
if(curval<0)or((curval>15)and(curval<>18))then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(707);
end;begin helpptr:=2;helpline[1]:=708;helpline[0]:=704;end;
interror(curval);curval:=0;end;end;{:1385}{577:}procedure scanfontident;
var f:internalfontnumber;m:halfword;begin{406:}repeat getxtoken;
until curcmd<>10{:406};
...
if filelineerrorstylep then printfileline else printnl(262);print(834);
...
repeat if fmemptr=fontmemsize then overflow(841,fontmemsize);
...
if filelineerrorstylep then printfileline else printnl(262);print(817);
end;printesc(hash[15525+f].rh);print(837);printint(fontparams[f]);
print(838);begin helpptr:=2;helpline[1]:=839;helpline[0]:=840;end;error;
end{:579};end;
...
begin curval:=15525+curval;curvallevel:=4;end;end{:415};
...
begin curval:=nest[p].pgfield;curvallevel:=0;end;end{:422};
...
84:{423:}begin if eqtb[25057].hh.rh=-268435455 then curval:=0 else
curval:=mem[eqtb[25057].hh.rh].hh.lh;curvallevel:=0;end{:423};
83:{420:}begin scaneightbitint;
if eqtb[25323+curval].hh.rh=-268435455 then curval:=0 else curval:=mem[
eqtb[25323+curval].hh.rh+m].int;curvallevel:=1;end{:420};
...
3:curval:=eqtb[24801+curval].hh.rh;end;curvallevel:=m;end{:427};
...
others:{428:}begin begin if interaction=3 then;
...
if vacuous then{446:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(679);
end;begin helpptr:=3;helpline[2]:=680;helpline[1]:=681;helpline[0]:=682;
end;backerror;end{:446}else if curcmd<>10 then backinput;end{:444};
...
if curvallevel<>0 then begin{451:}if curvallevel>=2 then begin v:=mem[
curval+1].int;deleteglueref(curval);curval:=v;end{:451};
...
if curtok=3116 then curtok:=3118;
if(radix=10)and(curtok=3118)then{452:}begin k:=0;p:=-268435455;gettoken;
...
{453:}if inf then{454:}if scankeyword(309)then begin curorder:=1;
...
if scankeyword(723)then v:=({558:}fontinfo[6+parambase[eqtb[25579].hh.rh
]].int{:558})else if scankeyword(724)then v:=({559:}fontinfo[5+parambase
[eqtb[25579].hh.rh]].int{:559})else goto 45;{443:}begin getxtoken;
if curcmd<>10 then backinput;end{:443};
40:curval:=multandadd(savecurval,v,xnoverd(v,f,65536),1073741823);
goto 89;45:{:455};
if mu then{456:}if scankeyword(334)then goto 88 else begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(720);
end;print(725);begin helpptr:=4;helpline[3]:=726;helpline[2]:=727;
helpline[1]:=728;helpline[0]:=729;end;error;goto 88;end{:456};
if scankeyword(719)then{457:}begin preparemag;
...
{458:}if scankeyword(730)then begin num:=7227;denom:=100;
...
end else if scankeyword(737)then goto 30 else{459:}begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(720);
...
strtoks:=p;end;{:464}{465:}function thetoks:halfword;
var oldsetting:0..21;p,q,r:halfword;b:poolpointer;begin getxtoken;
scansomethinginternal(5,false);
if curvallevel>=4 then{466:}begin p:=memtop-3;mem[p].hh.rh:=-268435455;
...
end;end;thetoks:=p;end{:466}else begin oldsetting:=selector;
...
{:465}{467:}procedure insthetoks;begin mem[memtop-12].hh.rh:=thetoks;
begintokenlist(mem[memtop-3].hh.rh,4);end;
{:467}{470:}procedure convtoks;var oldsetting:0..21;c:0..5;
savescannerstatus:smallnumber;b:poolpointer;begin c:=curchr;
{471:}case c of 0,1:scanint;2,3:begin savescannerstatus:=scannerstatus;
...
{472:}case c of 0:printint(curval);1:printromanint(curval);
...
end;begin helpptr:=2;helpline[1]:=760;helpline[0]:=761;end;error;
goto 22;end else begin incr(t);
if curtok<>t then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(762);
end;begin helpptr:=2;helpline[1]:=763;helpline[0]:=764;end;backerror;
end;curtok:=s;end;end{:476};begin q:=getavail;mem[p].hh.rh:=q;
mem[q].hh.lh:=curtok;p:=q;end;end;31:begin q:=getavail;mem[p].hh.rh:=q;
mem[q].hh.lh:=3584;p:=q;end;
if curcmd=2 then{475:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(672);
end;incr(alignstate);begin helpptr:=2;helpline[1]:=757;helpline[0]:=758;
end;error;goto 40;end{:475};30:end{:474}else scanleftbrace;
{477:}unbalance:=1;
...
].hh.rh;p:=q;end;end;end;32:xtoken end{:478}else gettoken;
...
end;sprintcs(warningindex);begin helpptr:=3;helpline[2]:=766;
helpline[1]:=767;helpline[0]:=768;end;backerror;curtok:=s;
...
fatalerror(769);
end{:484}else if readopen[m]=1 then{485:}if inputln(readfile[m],false)
...
if filelineerrorstylep then printfileline else printnl(262);print(770);
end;printesc(547);begin helpptr:=1;helpline[0]:=771;end;
alignstate:=1000000;curinput.limitfield:=0;error;end;end;end{:486};
curinput.limitfield:=last;
if(eqtb[27215].int<0)or(eqtb[27215].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[27215].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
...
while true do begin if q=-268435455 then confusion(772);
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(796);
end;printcmdchr(105,thisif);begin helpptr:=1;helpline[0]:=797;end;
backerror;r:=61;end;
...
9,10,11:{505:}begin scaneightbitint;p:=eqtb[25323+curval].hh.rh;
...
end{:505};12:{507:}begin savescannerstatus:=scannerstatus;
...
end{:508};scannerstatus:=savescannerstatus;end{:507};
...
if eqtb[27203].int>1 then begin begindiagnostic;print(798);printint(n);
...
if eqtb[27203].int>1 then{502:}begin begindiagnostic;
if b then print(794)else print(795);enddiagnostic(false);end{:502};
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(792);
end;printesc(790);begin helpptr:=1;helpline[0]:=793;end;error;
...
nameoffile[namelength+1]:=0;end;
{:523}{525:}function makenamestring:strnumber;var k:1..maxint;
...
{:525}{526:}procedure scanfilename;label 30;
var savewarningindex:halfword;begin nameinprogress:=true;
savewarningindex:=warningindex;warningindex:=curcs;
{406:}repeat getxtoken;until curcmd<>10{:406};backinput;
if curcmd=1 then begin scanfilenamebraced;
end else begin nameinprogress:=true;beginname;{406:}repeat getxtoken;
until curcmd<>10{:406};
...
end;{:526}{529:}procedure packjobname(s:strnumber);begin curarea:=335;
...
if s=800 then begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(801);
end else begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(802);
end;printfilename(curname,curarea,curext);print(803);
if(e=804)or(e=335)then showcontext;println;
printcstring(promptfilenamehelpmsg);if(e<>335)then begin print(805);
print(e);print(39);end;print(41);println;printnl(806);print(s);
if interaction<2 then fatalerror(807);savedcurname:=curname;
savedcurext:=curext;savedcurarea:=curarea;;begin;print(581);terminput;
end;{531:}begin beginname;k:=first;
...
if jobname=0 then jobname:=getjobname(810);packjobname(811);
recorderchangefilename(stringcast(nameoffile+1));packjobname(812);
while not aopenout(logfile)do{535:}begin selector:=17;
promptfilename(814,812);end{:535};
texmflogname:=amakenamestring(logfile);selector:=18;logopened:=true;
{536:}begin if srcspecialsp or filelineerrorstylep or parsefirstlinep
then write(logfile,'This is TeXk, Version 3.141592653')else write(
logfile,'This is TeX, Version 3.141592653');
write(logfile,versionstring);slowprint(formatident);print(815);
...
printchar(58);printtwo(systime mod 60);
...
fputs(translatefilename,logfile);write(logfile,')');end;end{:536};
...
end;end;inputstack[inputptr]:=curinput;printnl(813);
...
fflush(stdout);curinput.statefield:=33;{538:}begin line:=1;
if inputln(inputfile[curinput.indexfield],false)then;firmuptheline;
if(eqtb[27215].int<0)or(eqtb[27215].int>255)then decr(curinput.
limitfield)else buffer[curinput.limitfield]:=eqtb[27215].int;
first:=curinput.limitfield+1;curinput.locfield:=curinput.startfield;
end{:538};end;{:537}{560:}{1396:}function effectivechar(errp:boolean;
...
printnl(842);print(1346);print(c);print(843);slowprint(fontname[f]);
...
end else if s<>-1000 then begin print(818);printint(-s);end;print(827);
begin helpptr:=4;helpline[3]:=828;helpline[2]:=829;helpline[1]:=830;
helpline[0]:=831;end;error;goto 30;end{:567};f:=fontptr+1;
...
if s>=0 then begin print(756);printscaled(s);print(402);
end else if s<>-1000 then begin print(818);printint(-s);end;print(832);
begin helpptr:=1;helpline[0]:=833;end;error;z:=sw;end;
aritherror:=savearitherror;end;fontsize[f]:=z;end{:568};
{569:}for k:=fmemptr to widthbase[f]-1 do begin begin tfmtemp:=getc(
...
{574:}for k:=extenbase[f]to parambase[f]-1 do begin begin tfmtemp:=getc(
tfmfile);a:=tfmtemp;qw.b0:=a;tfmtemp:=getc(tfmfile);b:=tfmtemp;qw.b1:=b;
tfmtemp:=getc(tfmfile);c:=tfmtemp;qw.b2:=c;tfmtemp:=getc(tfmfile);
d:=tfmtemp;qw.b3:=d;fontinfo[k].qqqq:=qw;end;
...
{575:}begin for k:=1 to np do if k=1 then begin tfmtemp:=getc(tfmfile);
...
fontptr:=f;g:=f;goto 30{:576}{:562};
11:{561:}begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(817);
end;sprintcs(u);printchar(61);printfilename(nom,aire,335);
if s>=0 then begin print(756);printscaled(s);print(402);
end else if s<>-1000 then begin print(818);printint(-s);end;
if fileopened then print(819)else if nametoolong then print(820)else
print(821);begin helpptr:=5;helpline[4]:=822;helpline[3]:=823;
helpline[2]:=824;helpline[1]:=825;helpline[0]:=826;end;error{:561};
30:if fileopened then bclose(tfmfile);readfontinfo:=g;end;
{:560}{581:}procedure charwarning(f:internalfontnumber;c:eightbits);
begin if eqtb[27202].int>0 then begin begindiagnostic;printnl(842);
print(c);print(843);slowprint(fontname[f]);printchar(33);
...
10:end;{:582}{598:}procedure dviswap;
...
while p<>-268435455 do begin if mem[p+1].int=w then{612:}case mstate+mem
[p].hh.lh of 3,4,15,16:if mem[p+2].int<dvigone then goto 45 else{613:}
begin k:=mem[p+2].int-dvioffset;if k<0 then k:=k+dvibufsize;
dvibuf[k]:=dvibuf[k]+5;mem[p].hh.lh:=1;goto 40;end{:613};
...
writenoexpanding:=true;{1371:}q:=getavail;mem[q].hh.lh:=637;r:=getavail;
...
if curtok<>19617 then{1372:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1340);
end;begin helpptr:=2;helpline[1]:=1341;helpline[0]:=1031;end;error;
repeat gettoken;until curtok=19617;end{:1372};
...
:=19;if not logopened then selector:=17;printnl(1332);
for d:=0 to(poolptr-strstart[strptr])-1 do begin print(strpool[strstart[
strptr]+d]);end;print(1333);
...
clobbered:=true;end;
if clobbered then print(1334)else begin runsystemret:=runsystem(
conststringcast(addressof(strpool[strstart[strptr]])));
if runsystemret=-1 then print(1335)else if runsystemret=0 then print(
1336)else if runsystemret=1 then print(1337)else if runsystemret=2 then
print(1338)end;end else begin print(1339);end;printchar(46);
printnl(335);println;poolptr:=strstart[strptr];end;selector:=oldsetting;
end;{:1370}{1373:}procedure outwhat(p:halfword);var j:smallnumber;
oldsetting:0..21;
...
if curext=335 then curext:=804;packfilename(curname,curarea,curext);
while not kpseoutnameok(stringcast(nameoffile+1))or not aopenout(
writefile[j])do promptfilename(1343,804);writeopen[j]:=true;
if logopened and texmfyesno('log_openout')then begin oldsetting:=
selector;if(eqtb[27196].int<=0)then selector:=18 else selector:=19;
printnl(1344);printint(j);print(1345);
printfilename(curname,curarea,curext);print(803);printnl(335);println;
selector:=oldsetting;end;end;end;end{:1374};3:specialout(p);4:;
others:confusion(1342)end;end;{:1373}procedure hlistout;
label 21,13,14,15,22,40;var baseline:scaled;leftedge:scaled;
...
while p<>-268435455 do{620:}21:if(p>=himemmin)then begin if curh<>dvih
...
printnl(1347);print(c);print(1228);print(accentc);print(32);
print(basec);print(843);slowprint(fontname[f]);printchar(33);
enddiagnostic(false);goto 22;end;begindiagnostic;printnl(842);
print(1346);print(c);print(843);slowprint(fontname[f]);printchar(33);
enddiagnostic(false);goto 22{:1400};
40:{1401:}if eqtb[27202].int>99 then begin begindiagnostic;
printnl(1348);print(c);print(1228);print(accentc);print(32);
print(basec);print(843);slowprint(fontname[f]);printchar(46);
...
6:{652:}begin mem[memtop-12]:=mem[p+1];
...
topedge:=curv;
while p<>-268435455 do{630:}begin if(p>=himemmin)then confusion(846)else
{631:}begin case mem[p].hh.b0 of 0,1:{632:}if mem[p+5].hh.rh=-268435455
...
begin if eqtb[27201].int>0 then begin printnl(335);println;print(847);
...
end;begin helpptr:=2;helpline[1]:=852;helpline[0]:=853;end;error;
if eqtb[27201].int<=0 then begin begindiagnostic;printnl(854);
...
.int{:641};{617:}dvih:=0;dviv:=0;curh:=eqtb[27759].int;dvif:=0;
if outputfilename=0 then begin if jobname=0 then openlogfile;
packjobname(808);while not bopenout(dvifile)do promptfilename(809,808);
...
incr(dviptr);if dviptr=dvilimit then dviswap;end;
end else begin oldsetting:=selector;selector:=21;print(845);
...
if dviptr>(2147483647-dvioffset)then begin curs:=-2;fatalerror(844);end;
...
{639:}ifdef('STAT')if eqtb[27198].int>1 then begin printnl(848);
printint(varused);printchar(38);printint(dynused);printchar(59);end;
endif('STAT')flushnodelist(p);
ifdef('STAT')if eqtb[27198].int>1 then begin print(849);
printint(varused);printchar(38);printint(dynused);print(850);
printint(himemmin-lomemmax-1);println;end;endif('STAT'){:639};end;
...
if scankeyword(861)then speccode:=0 else if scankeyword(862)then
...
{:645}{649:}function hpack(p:halfword;w:scaled;m:smallnumber):halfword;
...
while p<>-268435455 do{651:}begin 21:while(p>=himemmin)do{654:}begin f:=
mem[p].hh.b0;
...
if p<>-268435455 then begin case mem[p].hh.b0 of 0,1,2,13:{653:}begin x
...
3,4,5:if adjusttail<>-268435455 then{655:}begin while mem[q].hh.rh<>p do
q:=mem[q].hh.rh;
...
if o=0 then if mem[r+5].hh.rh<>-268435455 then{660:}begin lastbadness:=
badness(x,totalstretch[0]);
if lastbadness>eqtb[27193].int then begin println;
if lastbadness>100 then printnl(863)else printnl(864);print(865);
...
{666:}if(-x-totalshrink[0]>eqtb[27749].int)or(eqtb[27193].int<100)then
...
println;printnl(871);printscaled(-x-totalshrink[0]);print(872);goto 50;
end{:666};
end else if o=0 then if mem[r+5].hh.rh<>-268435455 then{667:}begin
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[27193].int then begin println;printnl(873);
printint(lastbadness);goto 50;end;end{:667};goto 10;end{:664}{:657};
50:{663:}if outputactive then print(866)else begin if packbeginline<>0
then begin if packbeginline>0 then print(867)else print(868);
printint(abs(packbeginline));print(869);end else print(870);
...
totalshrink[1]:=0;totalstretch[2]:=0;totalshrink[2]:=0;
totalstretch[3]:=0;totalshrink[3]:=0{:650};
while p<>-268435455 do{669:}begin if(p>=himemmin)then confusion(874)else
case mem[p].hh.b0 of 0,1,2,13:{670:}begin x:=x+d+mem[p+3].int;
...
if totalstretch[o]<>0 then mem[r+6].gr:=x/totalstretch[o]else begin mem[
r+5].hh.b0:=0;mem[r+6].gr:=0.0;end;
if o=0 then if mem[r+5].hh.rh<>-268435455 then{674:}begin lastbadness:=
badness(x,totalstretch[0]);
if lastbadness>eqtb[27194].int then begin println;
if lastbadness>100 then printnl(863)else printnl(864);print(875);
...
if(totalshrink[o]<-x)and(o=0)and(mem[r+5].hh.rh<>-268435455)then begin
lastbadness:=1000000;mem[r+6].gr:=1.0;
{677:}if(-x-totalshrink[0]>eqtb[27750].int)or(eqtb[27194].int<100)then
begin println;printnl(876);printscaled(-x-totalshrink[0]);print(877);
goto 50;end{:677};
end else if o=0 then if mem[r+5].hh.rh<>-268435455 then{678:}begin
lastbadness:=badness(-x,totalshrink[0]);
if lastbadness>eqtb[27194].int then begin println;printnl(878);
printint(lastbadness);goto 50;end;end{:678};goto 10;end{:676}{:672};
50:{675:}if outputactive then print(866)else begin if packbeginline<>0
then begin print(868);printint(abs(packbeginline));print(869);
end else print(870);printint(line);println;end;begindiagnostic;
...
repeat z:=z-16;g:=eqtb[25583+z].hh.rh;if g<>0 then{708:}begin y:=x;
...
end;{:718}{720:}procedure mlisttohlist;forward;
...
hpack(q,0,1);{721:}q:=mem[x+5].hh.rh;
...
mem[q].hh.rh:=-268435455;end;end{:721};cleanbox:=x;end;
{:720}{722:}procedure fetch(a:halfword);begin curc:=mem[a].hh.b1;
curf:=eqtb[25583+mem[a].hh.b0+cursize].hh.rh;
if curf=0 then{723:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(335);
end;printsize(cursize);printchar(32);printint(mem[a].hh.b0);print(903);
print(curc);printchar(41);begin helpptr:=4;helpline[3]:=904;
helpline[2]:=905;helpline[1]:=906;helpline[0]:=907;end;error;
...
mem[v+5].hh.rh:=x{:747};
{748:}if curstyle<2 then delta:=fontinfo[20+parambase[eqtb[25585+cursize
...
end;end;{:756}{762:}function makeleftright(q:halfword;style:smallnumber;
...
div 2);
curmu:=xovern(fontinfo[6+parambase[eqtb[25585+cursize].hh.rh]].int,18);
end{:703};while q<>-268435455 do{727:}begin{728:}21:delta:=0;
...
end;end{:732};goto 81;end;11:begin mathkern(q,curmu);goto 81;end;
{:730}others:confusion(908)end;
...
;delta:=0;end;end else p:=-268435455;end{:755};0:p:=-268435455;
...
others:confusion(909)end;mem[q+1].int:=p;
...
{729:}if rtype=18 then mem[r].hh.b0:=16{:729};{760:}p:=memtop-3;
mem[p].hh.rh:=-268435455;q:=mlist;rtype:=0;curstyle:=style;
{703:}begin if curstyle<4 then cursize:=0 else cursize:=16*((curstyle-2)
div 2);
curmu:=xovern(fontinfo[6+parambase[eqtb[25585+cursize].hh.rh]].int,18);
end{:703};while q<>-268435455 do begin{761:}t:=16;s:=4;pen:=10000;
...
52:if curstyle<4 then x:=17 else x:=0;others:confusion(912)end;
...
{767:}if mem[q+1].int<>-268435455 then begin mem[p].hh.rh:=mem[q+1].int;
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(695);end;printesc(533);print(913);begin helpptr:=3;
helpline[2]:=914;helpline[1]:=915;helpline[0]:=916;end;error;flushmath;
end{:776};pushnest;
...
modefield{:775};scanspec(6,false);{777:}mem[memtop-8].hh.rh:=-268435455;
...
{779:}{783:}p:=memtop-4;mem[p].hh.rh:=-268435455;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(922);
end;begin helpptr:=3;helpline[2]:=923;helpline[1]:=924;helpline[0]:=925;
...
13);alignpeek;end;{:774}{786:}{787:}procedure initspan(p:halfword);
begin pushnest;
...
begin if curalign=-268435455 then confusion(928);q:=mem[curalign].hh.rh;
if q=-268435455 then confusion(928);
if alignstate<500000 then fatalerror(607);p:=mem[q].hh.rh;
{792:}if(p=-268435455)and(mem[curalign+5].hh.lh<257)then if curloop<>
-268435455 then{793:}begin mem[q].hh.rh:=newnullbox;p:=mem[q].hh.rh;
mem[p].hh.lh:=memtop-9;mem[p+1].int:=-1073741824;
curloop:=mem[curloop].hh.rh;{794:}q:=memtop-4;r:=mem[curloop+3].int;
...
while r<>-268435455 do begin mem[q].hh.rh:=getavail;q:=mem[q].hh.rh;
mem[q].hh.lh:=mem[r].hh.lh;r:=mem[r].hh.rh;end;mem[q].hh.rh:=-268435455;
mem[p+2].int:=mem[memtop-4].hh.rh{:794};curloop:=mem[curloop].hh.rh;
mem[p].hh.rh:=newglue(mem[curloop+1].hh.lh);mem[mem[p].hh.rh].hh.b1:=12;
end{:793}else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(929);
end;printesc(918);begin helpptr:=3;helpline[2]:=930;helpline[1]:=931;
helpline[0]:=932;end;mem[curalign+5].hh.lh:=257;error;end{:792};
...
if curspan<>curalign then{798:}begin q:=curspan;repeat incr(n);
q:=mem[mem[q].hh.rh].hh.rh;until q=curalign;
if n>255 then confusion(933);q:=curspan;
...
if eqtb[25065].hh.rh<>-268435455 then begintokenlist(eqtb[25065].hh.rh,
13);alignpeek;end;{:799}{800:}procedure doassignments;forward;
...
begin if curgroup<>6 then confusion(934);unsave;
if curgroup<>6 then confusion(935);unsave;
...
if mem[q].hh.lh<>memtop-9 then{803:}begin t:=mem[q+1].int+mem[mem[mem[q]
...
mem[q+4].int:=0;q:=p;until q=-268435455{:801};{804:}saveptr:=saveptr-2;
...
packbeginline:=0{:804};{805:}q:=mem[curlist.headfield].hh.rh;
s:=curlist.headfield;
while q<>-268435455 do begin if not(q>=himemmin)then if mem[q].hh.b0=13
then{807:}begin if curlist.modefield=-1 then begin mem[q].hh.b0:=0;
...
repeat{808:}n:=mem[r].hh.b1;t:=mem[s+1].int;w:=t;u:=memtop-4;
...
end{:806};s:=q;q:=mem[q].hh.rh;end{:805};flushnodelist(p);popalignment;
...
if curcmd<>3 then{1207:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1189);
end;begin helpptr:=2;helpline[1]:=914;helpline[0]:=915;end;backerror;
end{:1207}else{1197:}begin getxtoken;
if curcmd<>3 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1185);
end;begin helpptr:=2;helpline[1]:=1186;helpline[0]:=1187;end;backerror;
end;end{:1197};popnest;
...
ifdef('STAT')if eqtb[27199].int>0 then enddiagnostic(true);
endif('STAT')begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(936);
end;begin helpptr:=5;helpline[4]:=937;helpline[3]:=938;helpline[2]:=939;
helpline[1]:=940;helpline[0]:=941;end;error;
...
-10000{:831};nobreakyet:=true;prevr:=memtop-7;oldl:=0;
...
or(r=memtop-7))then{836:}begin if nobreakyet then{837:}begin nobreakyet
...
if breaktype>0 then if curp<>-268435455 then{840:}begin t:=mem[curp].hh.
b1;v:=curp;s:=mem[curp+1].hh.rh;while t>0 do begin decr(t);
v:=mem[v].hh.rh;{841:}if(v>=himemmin)then begin f:=mem[v].hh.b0;
...
others:confusion(942)end{:841};end;
while s<>-268435455 do begin{842:}if(s>=himemmin)then begin f:=mem[s].hh
.b0;
breakwidth[1]:=breakwidth[1]+fontinfo[widthbase[f]+fontinfo[charbase[f]+
...
others:confusion(943)end{:842};s:=mem[s].hh.rh;end;
breakwidth[1]:=breakwidth[1]+discwidth;
if mem[curp+1].hh.rh=-268435455 then s:=mem[v].hh.rh;end{:840};
...
ifdef('STAT')if eqtb[27199].int>0 then{846:}begin printnl(944);
printint(mem[passive].hh.lh);print(945);printint(mem[q+1].hh.lh-1);
printchar(46);printint(fitclass);if breaktype=1 then printchar(45);
print(946);printint(mem[q+2].int);print(947);
if mem[passive+1].hh.lh=-268435455 then printchar(48)else printint(mem[
mem[passive+1].hh.lh].hh.lh);end{:846};endif('STAT')end{:845};
...
{850:}if l>easyline then begin linewidth:=secondwidth;oldl:=268435454;
...
{851:}begin artificialdemerits:=false;
...
{855:}if artificialdemerits then d:=0 else{859:}begin d:=eqtb[27169].int
...
if abs(fitclass-mem[r].hh.b1)>1 then d:=d+eqtb[27183].int;end{:859};
ifdef('STAT')if eqtb[27199].int>0 then{856:}begin if printednode<>curp
then{857:}begin printnl(335);
...
printesc(340);end;print(948);
if mem[r+1].hh.rh=-268435455 then printchar(48)else printint(mem[mem[r+1
].hh.rh].hh.lh);print(949);
if b>10000 then printchar(42)else printint(b);print(950);printint(pi);
print(951);if artificialdemerits then printchar(42)else printint(d);
end{:856};endif('STAT')d:=d+mem[r+2].int;
...
curline:halfword;begin{878:}q:=mem[bestbet+1].hh.rh;curp:=-268435455;
repeat r:=q;q:=mem[q+1].hh.lh;mem[r+1].hh.lh:=curp;curp:=r;
until q=-268435455{:878};curline:=curlist.pgfield+1;
...
q:=r{:886};30:{:881};{887:}r:=mem[q].hh.rh;mem[q].hh.rh:=-268435455;
...
adjusttail:=-268435455{:888};
{890:}if curline+1<>bestline then begin pen:=eqtb[27180].int;
...
if curp<>-268435455 then if not postdiscbreak then{879:}begin r:=memtop
...
958);curlist.pgfield:=bestline-1;end;
...
{908:}curl:=hu[j];curq:=t;if j=0 then begin ligaturepresent:=initlig;
...
{:929}begin{923:}for j:=0 to hn do hyf[j]:=0;{930:}h:=hc[1];incr(hn);
...
{932:}s:=hyphlist[h];while s<>-268435455 do begin hyf[mem[s].hh.lh]:=1;
...
while hc[l]=trietrc[z]do begin if trietro[z]<>mintrieop then{924:}begin
...
41:{:902};{903:}q:=mem[hb].hh.rh;mem[hb].hh.rh:=-268435455;
...
{915:}minortail:=-268435455;mem[r+1].hh.lh:=-268435455;
...
end{:915};{916:}minortail:=-268435455;mem[r+1].hh.rh:=-268435455;
...
while mem[majortail].hh.rh>-268435455 do begin majortail:=mem[majortail]
.hh.rh;incr(rcount);end;end{:917};end{:916};
...
s:=majortail{:918};hyphenpassed:=j-1;mem[memtop-4].hh.rh:=-268435455;
until not odd(hyf[j-1]){:914};until j>hn;mem[s].hh.rh:=q{:913};
flushlist(initlist){:903};10:end;
{:895}{942:}ifdef('INITEX'){944:}function newtrieop(d,n:smallnumber;
...
if l=0 then begin if trieopptr=trieopsize then overflow(968,trieopsize);
u:=trieused[curlang];
if u=maxtrieop then overflow(969,maxtrieop-mintrieop);incr(trieopptr);
...
{954:}if triemax<h+256 then begin if triesize<=h+256 then overflow(970,
...
end;goto 40{:955};45:z:=trietrl[z];end;40:{956:}trietaken[h]:=true;
...
if filelineerrorstylep then printfileline else printnl(262);print(976);
end;begin helpptr:=1;helpline[0]:=975;end;error;end;end;
...
970,triesize);incr(trieptr);trier[trieptr]:=p;p:=trieptr;triel[p]:=0;
...
if filelineerrorstylep then printfileline else printnl(262);print(977);
end;begin helpptr:=1;helpline[0]:=975;end;error;end;trieo[q]:=v;
end{:963};if curcmd=2 then goto 30;k:=0;hyf[0]:=0;digitsensed:=false;
end;others:begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(974);
end;printesc(972);begin helpptr:=1;helpline[0]:=975;end;error;end end;
end;30:{:961};end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(971);
end;printesc(972);begin helpptr:=1;helpline[0]:=973;end;error;
...
until r>triemax;end;trietrc[0]:=63;{:958};trienotready:=false;end;
{:966}endif('INITEX'){:942}procedure linebreak(finalwidowpenalty:integer
);label 30,31,32,33,34,35,22;var{862:}autobreaking:boolean;
prevp:halfword;q,r,s,prevs:halfword;f:internalfontnumber;
{:862}{893:}j:smallnumber;c:0..255;
{:893}begin packbeginline:=curlist.mlfield;
{816:}mem[memtop-3].hh.rh:=mem[curlist.headfield].hh.rh;
...
{:834}{848:}if eqtb[25057].hh.rh=-268435455 then if eqtb[27758].int=0
then begin lastspecialline:=0;secondwidth:=eqtb[27744].int;
secondindent:=0;
end else{849:}begin lastspecialline:=abs(eqtb[27208].int);
...
secondindent:=0;end;
end{:849}else begin lastspecialline:=mem[eqtb[25057].hh.rh].hh.lh-1;
...
268435455{:848};{863:}threshold:=eqtb[27167].int;
if threshold>=0 then begin ifdef('STAT')if eqtb[27199].int>0 then begin
begindiagnostic;printnl(952);end;endif('STAT')secondpass:=false;
...
if secondpass then{891:}begin ifdef('INITEX')if trienotready then
inittrie;endif('INITEX')curlang:=initcurlang;lhyf:=initlhyf;
rhyf:=initrhyf;end{:891};{864:}q:=getnode(3);mem[q].hh.b0:=0;
...
while(curp<>-268435455)and(mem[memtop-7].hh.rh<>memtop-7)do{866:}begin
if(curp>=himemmin)then{867:}begin prevp:=curp;repeat f:=mem[curp].hh.b0;
...
s:=mem[prevs].hh.rh;
if s<>-268435455 then begin{896:}while true do begin if(s>=himemmin)then
...
if s=-268435455 then trybreak(eqtb[27171].int,1)else begin repeat{870:}
...
others:confusion(956)end{:870};s:=mem[s].hh.rh;until s=-268435455;
...
others:confusion(957)end{:871};decr(r);s:=mem[s].hh.rh;end;prevp:=curp;
...
12:trybreak(mem[curp+1].int,0);4,3,5:;others:confusion(955)end;
prevp:=curp;curp:=mem[curp].hh.rh;35:end{:866};
if curp=-268435455 then{873:}begin trybreak(-10000,1);
...
if eqtb[27186].int=0 then goto 30;{875:}begin r:=mem[memtop-7].hh.rh;
actuallooseness:=0;
...
end{:875};if(actuallooseness=eqtb[27186].int)or finalpass then goto 30;
...
printnl(953);endif('STAT')threshold:=eqtb[27168].int;secondpass:=true;
finalpass:=(eqtb[27761].int<=0);
end else begin ifdef('STAT')if eqtb[27199].int>0 then printnl(954);
...
normalizeselector;end;endif('STAT'){:863};
{876:}postlinebreak(finalwidowpenalty){:876};
{865:}q:=mem[memtop-7].hh.rh;
while q<>memtop-7 do begin curp:=mem[q].hh.rh;
if mem[q].hh.b0=2 then freenode(q,7)else freenode(q,3);q:=curp;end;
q:=passive;while q<>-268435455 do begin curp:=mem[q].hh.rh;
freenode(q,2);q:=curp;end{:865};packbeginline:=0;end;
{:815}{934:}procedure newhyphexceptions;label 21,10,40,45;var n:0..64;
...
curlang:=0 else curlang:=eqtb[27217].int;{935:}n:=0;p:=-268435455;
while true do begin getxtoken;
...
end{:938}else begin if eqtb[25887+curchr].hh.rh=0 then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(964);
end;begin helpptr:=2;helpline[1]:=965;helpline[0]:=966;end;error;
...
{940:}if hyphnext<=607 then while(hyphnext>0)and(hyphword[hyphnext-1]>0)
do decr(hyphnext);
if(hyphcount=hyphsize)or(hyphnext=0)then overflow(967,hyphsize);
...
while true do begin{972:}if p=-268435455 then pi:=-10000 else{973:}case
mem[p].hh.b0 of 0,1,2:begin activewidth[1]:=activewidth[1]+prevdp+mem[p
+3].int;prevdp:=mem[p+2].int;goto 45;end;8:{1365:}goto 45{:1365};
...
4,3:goto 45;others:confusion(979)end{:973};
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(980);end;begin helpptr:=4;helpline[3]:=981;helpline[2]:=982;
helpline[1]:=983;helpline[0]:=941;end;error;r:=newspec(q);
...
{978:}if v=-268435455 then begin vsplit:=-268435455;goto 10;end;
if mem[v].hh.b0<>1 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(335);
end;printesc(984);print(985);printesc(986);begin helpptr:=2;
helpline[1]:=987;helpline[0]:=988;end;error;vsplit:=-268435455;goto 10;
end{:978};q:=vertbreak(mem[v+5].hh.rh,h,eqtb[27747].int);
{979:}p:=mem[v+5].hh.rh;
...
print(997);end;if pagesofar[5]<>0 then begin print(310);
printscaled(pagesofar[5]);print(998);end;
...
printnl(1006);printscaled(pagesofar[0]);print(1007);
...
printnl(854);showbox(eqtb[25323+n].hh.rh);enddiagnostic(true);
...
3 then;if filelineerrorstylep then printfileline else printnl(262);
print(1008);end;begin helpptr:=3;helpline[2]:=1009;helpline[1]:=1010;
helpline[0]:=1011;end;boxerror(n);end;end;
...
begin{1013:}if mem[bestpagebreak].hh.b0=12 then begin geqworddefine(
27206,mem[bestpagebreak+1].int);mem[bestpagebreak+1].int:=10000;
end else geqworddefine(27206,10000){:1013};
...
{1014:}if c=bestpagebreak then bestpagebreak:=-268435455;
{1015:}if eqtb[25578].hh.rh<>-268435455 then begin begin if interaction=
3 then;if filelineerrorstylep then printfileline else printnl(262);
print(335);end;printesc(414);print(1022);begin helpptr:=2;
helpline[1]:=1023;helpline[0]:=1011;end;boxerror(255);end{:1015};
insertpenalties:=0;savesplittopskip:=eqtb[24537].hh.rh;
if eqtb[27220].int<=0 then{1018:}begin r:=mem[memtop].hh.rh;
...
r:=mem[r].hh.rh;end;end{:1018};q:=memtop-4;mem[q].hh.rh:=-268435455;
prevp:=memtop-2;p:=mem[prevp].hh.rh;
while p<>bestpagebreak do begin if mem[p].hh.b0=3 then begin if eqtb[
27220].int<=0 then{1020:}begin r:=mem[memtop].hh.rh;
...
end{:1021}else begin while mem[s].hh.rh<>-268435455 do s:=mem[s].hh.rh;
...
freenode(p,5);end;p:=prevp{:1022};end{:1020};
end else if mem[p].hh.b0=4 then{1016:}begin if curmark[1]=-268435455
...
{1017:}if p<>-268435455 then begin if mem[memtop-1].hh.rh=-268435455
...
{991:}pagecontents:=0;pagetail:=memtop-2;
...
then{1024:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1024);
end;printint(deadcycles);print(1025);begin helpptr:=3;helpline[2]:=1026;
helpline[1]:=1027;helpline[0]:=1028;end;error;
...
{1023:}begin if mem[memtop-2].hh.rh<>-268435455 then begin if mem[memtop
...
shipout(eqtb[25578].hh.rh);eqtb[25578].hh.rh:=-268435455;end{:1023};
10:end;{:1012}procedure buildpage;label 10,30,31,22,80,90;
...
{996:}if lastglue<>268435455 then deleteglueref(lastglue);
...
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(1017);end;printesc(400);printint(n);begin helpptr:=3;
helpline[2]:=1018;helpline[1]:=1019;helpline[0]:=941;end;error;end;
end{:1009};
...
end else{1010:}begin if eqtb[27229+n].int<=0 then w:=1073741823 else
...
ifdef('STAT')if eqtb[27200].int>0 then{1011:}begin begindiagnostic;
printnl(1020);printint(n);print(1021);printscaled(w);printchar(44);
printscaled(bestheightplusdepth);print(950);
...
end{:1010};end;goto 80;end{:1008};others:confusion(1012)end{:1000};
...
ifdef('STAT')if eqtb[27200].int>0 then{1006:}begin begindiagnostic;
printnl(37);print(946);printtotals;print(1015);
printscaled(pagesofar[0]);print(949);
if b=1073741823 then printchar(42)else printint(b);print(950);
printint(pi);print(1016);
...
if(mem[q].hh.b1<>0)and(mem[q+3].int<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(1013);end;begin helpptr:=4;helpline[3]:=1014;helpline[2]:=982;
helpline[1]:=983;helpline[0]:=941;end;error;r:=newspec(q);
mem[r].hh.b1:=0;deleteglueref(q);mem[p+1].hh.lh:=r;q:=r;end;end;
...
goto 30{:998};31:{999:}mem[memtop-1].hh.rh:=mem[p].hh.rh;
mem[p].hh.rh:=-268435455;flushnodelist(p){:999};30:{:997};
until mem[memtop-1].hh.rh=-268435455;
{995:}if nestptr=0 then curlist.tailfield:=memtop-1 else nest[0].
tailfield:=memtop-1{:995};10:end;{:994}{1030:}{1043:}procedure appspace;
var q:halfword;
...
eqtb[24539].hh.rh else{1042:}begin mainp:=fontglue[eqtb[25579].hh.rh];
...
fontglue[eqtb[25579].hh.rh]:=mainp;end;end{:1042};mainp:=newspec(mainp);
...
{:1044};q:=newglue(mainp);mem[mainp].hh.rh:=-268435455;end;
mem[curlist.tailfield].hh.rh:=q;curlist.tailfield:=q;end;
{:1043}{1047:}procedure insertdollarsign;begin backinput;curtok:=804;
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1036);
end;begin helpptr:=2;helpline[1]:=1037;helpline[0]:=1038;end;inserror;
end;{:1047}{1049:}procedure youcant;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(700);
...
if filelineerrorstylep then printfileline else printnl(262);print(792);
end;printcmdchr(curcmd,curchr);begin helpptr:=1;helpline[0]:=1061;end;
error;end{:1066}else begin backinput;p:=getavail;mem[memtop-3].hh.rh:=p;
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(640);
end;{1065:}case curgroup of 14:begin mem[p].hh.lh:=19611;printesc(529);
end;15:begin mem[p].hh.lh:=804;printchar(36);end;
16:begin mem[p].hh.lh:=19612;mem[p].hh.rh:=getavail;p:=mem[p].hh.rh;
mem[p].hh.lh:=3118;printesc(1060);end;others:begin mem[p].hh.lh:=637;
printchar(125);end end{:1065};print(641);
begintokenlist(mem[memtop-3].hh.rh,4);begin helpptr:=5;
helpline[4]:=1055;helpline[3]:=1056;helpline[2]:=1057;helpline[1]:=1058;
helpline[0]:=1059;end;error;end;end;
{:1064}{1069:}procedure extrarightbrace;
begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1066);
end;case curgroup of 14:printesc(529);15:printchar(36);16:printesc(896);
end;begin helpptr:=5;helpline[4]:=1067;helpline[3]:=1068;
helpline[2]:=1069;helpline[1]:=1070;helpline[0]:=1071;end;error;
incr(alignstate);end;{:1069}{1070:}procedure normalparagraph;
...
end;{:1070}{1075:}procedure boxend(boxcontext:integer);var p:halfword;
begin if boxcontext<1073741824 then{1076:}begin if curbox<>-268435455
...
geqdefine(-1073716757+boxcontext,119,curbox){:1077}else if curbox<>
-268435455 then if boxcontext>1073742336 then{1078:}begin{404:}repeat
getxtoken;until(curcmd<>10)and(curcmd<>0){:404};
...
if filelineerrorstylep then printfileline else printnl(262);print(1084);
end;begin helpptr:=3;helpline[2]:=1085;helpline[1]:=1086;
helpline[0]:=1087;end;backerror;flushnodelist(curbox);end;
end{:1078}else shipout(curbox);end;
{:1075}{1079:}procedure beginbox(boxcontext:integer);label 10,30;
...
30:end{:1081};end;end{:1080};3:{1082:}begin scaneightbitint;n:=curval;
if not scankeyword(861)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1091);
end;begin helpptr:=2;helpline[1]:=1092;helpline[0]:=1093;end;error;end;
...
10);end;goto 10;end{:1083}end;boxend(boxcontext);10:end;
...
if filelineerrorstylep then printfileline else printnl(262);print(1094);
end;begin helpptr:=3;helpline[2]:=1095;helpline[1]:=1096;
helpline[0]:=1097;end;backerror;end;end;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(700);
end;printesc(534);print(1100);begin helpptr:=2;helpline[1]:=1101;
helpline[0]:=1102;end;error;end else begin backinput;curtok:=partoken;
backinput;curinput.indexfield:=4;end;end;
{:1095}{1096:}procedure endgraf;
...
end;printesc(327);printint(255);begin helpptr:=1;helpline[0]:=1104;end;
...
{:1099}{1101:}procedure makemark;var p:halfword;
...
then{1106:}begin if(curchr<>10)or(lastglue<>268435455)then begin youcant
;begin helpptr:=2;helpline[1]:=1089;helpline[0]:=1105;end;
if curchr=11 then helpline[0]:=(1106)else if curchr<>10 then helpline[0]
:=(1107);error;end;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1115);
end;begin helpptr:=3;helpline[2]:=1116;helpline[1]:=1117;
helpline[0]:=1118;end;error;goto 10;end;
...
end;begin helpptr:=1;helpline[0]:=1126;end;error;begindiagnostic;
printnl(1127);showbox(p);enddiagnostic(true);flushnodelist(p);
mem[q].hh.rh:=-268435455;goto 30;end;q:=p;p:=mem[q].hh.rh;incr(n);end;
30:{:1121};p:=mem[curlist.headfield].hh.rh;popnest;
...
end;printesc(346);begin helpptr:=2;helpline[1]:=1120;helpline[0]:=1121;
...
end;begin helpptr:=2;helpline[1]:=1123;helpline[0]:=1124;end;error;end;
...
{:1119}{1123:}procedure makeaccent;var s,t:real;p,q,r:halfword;
...
].hh.b1)].qqqq.b0].int;doassignments;{1124:}q:=-268435455;
f:=eqtb[25579].hh.rh;
...
if q<>-268435455 then{1125:}begin t:=fontinfo[1+parambase[f]].int
/65536.0;
...
if filelineerrorstylep then printfileline else printnl(262);print(1132);
end;printcmdchr(curcmd,curchr);
if curtok=1062 then begin begin helpptr:=6;helpline[5]:=1133;
helpline[4]:=1134;helpline[3]:=1135;helpline[2]:=1136;helpline[1]:=1137;
helpline[0]:=1138;end;end else begin begin helpptr:=5;helpline[4]:=1133;
helpline[3]:=1139;helpline[2]:=1136;helpline[1]:=1137;helpline[0]:=1138;
...
end;decr(alignstate);curtok:=637;end;begin helpptr:=3;helpline[2]:=1129;
helpline[1]:=1130;helpline[0]:=1131;end;inserror;end;end;
{:1127}{1129:}procedure noalignerror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1132);
end;printesc(540);begin helpptr:=2;helpline[1]:=1140;helpline[0]:=1141;
end;error;end;procedure omiterror;begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1132);
end;printesc(543);begin helpptr:=2;helpline[1]:=1142;helpline[0]:=1141;
end;error;end;{:1129}{1131:}procedure doendv;begin baseptr:=inputptr;
...
end;{:1131}{1135:}procedure cserror;
begin if curchr=10 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(792);
end;printesc(528);begin helpptr:=1;helpline[0]:=1144;end;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(792);
end;printesc(517);begin helpptr:=1;helpline[0]:=1145;end;end;error;end;
{:1135}{1136:}procedure pushmath(c:groupcode);begin pushnest;
curlist.modefield:=-203;curlist.auxfield.int:=-268435455;
newsavelevel(c);end;{:1136}{1138:}procedure initmath;label 21,40,45,30;
...
{1146:}v:=mem[justbox+4].int+2*fontinfo[6+parambase[eqtb[25579].hh.rh]].
int;w:=-1073741823;p:=mem[justbox+5].hh.rh;
while p<>-268435455 do begin{1147:}21:if(p>=himemmin)then begin f:=mem[p
].hh.b0;
...
{1149:}if eqtb[25057].hh.rh=-268435455 then if(eqtb[27758].int<>0)and(((
...
{1139:}begin pushmath(15);eqworddefine(27211,-1);
...
end;begin helpptr:=1;helpline[0]:=1150;end;error;10:end;
...
if curval<0 then{1161:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1151);
end;begin helpptr:=6;helpline[5]:=1152;helpline[4]:=1153;
helpline[3]:=1154;helpline[2]:=1155;helpline[1]:=1156;helpline[0]:=1157;
...
if filelineerrorstylep then printfileline else printnl(262);print(1158);
end;printesc(536);print(1159);begin helpptr:=2;helpline[1]:=1160;
helpline[0]:=1161;end;error;end{:1166};
...
var q:halfword;
begin if curlist.auxfield.int<>-268435455 then{1185:}begin mem[curlist.
...
auxfield.int+2].hh.lh;if mem[q].hh.b0<>30 then confusion(896);
...
{:1174}{1176:}procedure subsup;var t:smallnumber;p:halfword;begin t:=0;
p:=-268435455;
...
if(p=-268435455)or(t<>0)then{1177:}begin begin mem[curlist.tailfield].hh
...
if filelineerrorstylep then printfileline else printnl(262);print(1162);
end;begin helpptr:=1;helpline[0]:=1163;end;
end else begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1164);
end;begin helpptr:=1;helpline[0]:=1165;end;end;error;end;end{:1177};
scanmath(p);end;{:1176}{1181:}procedure mathfraction;var c:smallnumber;
begin c:=curchr;
if curlist.auxfield.int<>-268435455 then{1183:}begin if c>=3 then begin
scandelimiter(memtop-12,false);scandelimiter(memtop-12,false);end;
if c mod 3=0 then scandimen(false,false,false);
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1172);
end;begin helpptr:=3;helpline[2]:=1173;helpline[1]:=1174;
helpline[0]:=1175;end;error;
end{:1183}else begin curlist.auxfield.int:=getnode(6);
...
if filelineerrorstylep then printfileline else printnl(262);print(792);
end;printesc(896);begin helpptr:=1;helpline[0]:=1176;end;error;
...
{1195:}if(fontparams[eqtb[25585].hh.rh]<22)or(fontparams[eqtb[25601].hh.
rh]<22)or(fontparams[eqtb[25617].hh.rh]<22)then begin begin if
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1177);
end;begin helpptr:=3;helpline[2]:=1178;helpline[1]:=1179;
helpline[0]:=1180;end;error;flushmath;danger:=true;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1181);
end;begin helpptr:=3;helpline[2]:=1182;helpline[1]:=1183;
helpline[0]:=1184;end;error;flushmath;danger:=true;end{:1195};
m:=curlist.modefield;l:=false;p:=finmlist(-268435455);
if curlist.modefield=-m then begin{1197:}begin getxtoken;
if curcmd<>3 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1185);
end;begin helpptr:=2;helpline[1]:=1186;helpline[0]:=1187;end;backerror;
end;end{:1197};curmlist:=p;curstyle:=2;mlistpenalties:=false;
...
end{:1196}else begin if a=-268435455 then{1197:}begin getxtoken;
if curcmd<>3 then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1185);
end;begin helpptr:=2;helpline[1]:=1186;helpline[0]:=1187;end;backerror;
end;end{:1197};{1199:}curmlist:=p;curstyle:=0;mlistpenalties:=false;
...
:=0;end{:1202};
{1203:}begin mem[curlist.tailfield].hh.rh:=newpenalty(eqtb[27178].int);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
{1205:}if(a<>-268435455)and(e=0)and not l then begin begin mem[curlist.
tailfield].hh.rh:=newpenalty(10000);
curlist.tailfield:=mem[curlist.tailfield].hh.rh;end;
...
begin if curgroup<>15 then confusion(1188);unsave;
...
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1203);
end;begin helpptr:=5;helpline[4]:=1204;helpline[3]:=1205;
helpline[2]:=1206;helpline[1]:=1207;helpline[0]:=1208;end;
...
begin helpptr:=1;helpline[0]:=1242;end;error;goto 10;end;end;p:=curchr;
scaneightbitint;case p of 0:l:=curval+27229;1:l:=curval+27762;
2:l:=curval+24545;3:l:=curval+24801;end;end;40:{:1237};
if q=89 then scanoptionalequals else if scankeyword(1238)then;
aritherror:=false;
...
end;begin helpptr:=2;helpline[1]:=1240;helpline[0]:=1241;end;
...
end;begin helpptr:=1;helpline[0]:=1246;end;interror(curval);
...
if filelineerrorstylep then printfileline else printnl(262);print(974);
end;printesc(545);begin helpptr:=1;helpline[0]:=1247;end;
...
curval;end;{:1247}{1257:}procedure newfont(a:smallnumber);label 50;
...
if u>=514 then t:=hash[u].rh else if u>=257 then if u=513 then t:=1251
else t:=u-257 else begin oldsetting:=selector;selector:=21;print(1251);
...
if scankeyword(1252)then{1259:}begin scandimen(false,false,false);
s:=curval;
if(s<=0)or(s>=134217728)then begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1254);
end;printscaled(s);print(1255);begin helpptr:=2;helpline[1]:=1256;
helpline[0]:=1257;end;error;s:=10*65536;end;
end{:1259}else if scankeyword(1253)then begin scanint;s:=-curval;
...
end else s:=-1000;nameinprogress:=false{:1258};
{1260:}for f:=1 to fontptr do if streqstr(fontname[f],curname)and
...
goto 50;end;end{:1260};f:=readfontinfo(u,curname,curarea,s);
50:eqtb[u].hh.rh:=f;eqtb[15525+f]:=eqtb[u];hash[15525+f].rh:=t;end;
...
if curcmd<=70 then{1212:}begin begin if interaction=3 then;
...
helpline[0]:=1199;end;backerror;goto 10;end{:1212};end;
{1213:}if(curcmd<>97)and(a mod 4<>0)then begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(700);end;printesc(1190);print(1200);printesc(1191);print(1201);
printcmdchr(curcmd,curchr);printchar(39);begin helpptr:=1;
helpline[0]:=1202;end;error;end{:1213};
{1214:}if eqtb[27210].int<>0 then if eqtb[27210].int<0 then begin if(a>=
4)then a:=a-4;end else begin if not(a>=4)then a:=a+4;end{:1214};
case curcmd of{1217:}87:if(a>=4)then geqdefine(25579,120,curchr)else
eqdefine(25579,120,curchr);
{:1217}{1218:}97:begin if odd(curchr)and not(a>=4)and(eqtb[27210].int>=0
...
4),defref);end;
{:1218}{1221:}94:if curchr=11 then else if curchr=10 then begin selector
...
helpline[0]:=1214;end;backerror;end;p:=mem[r].hh.rh;
...
print(1215);end;printesc(1212);print(1216);begin helpptr:=2;
helpline[1]:=1217;helpline[0]:=1218;end;error;
...
end;{:1221}{1224:}95:if curchr=7 then begin scancharnum;p:=26911+curval;
scanoptionalequals;scancharnum;n:=curval;scancharnum;
if(eqtb[27224].int>0)then begin begindiagnostic;printnl(1227);
print(p-26911);print(1228);print(n);printchar(32);print(curval);
...
{:1228}{1232:}85:begin{1233:}if curchr=25631 then n:=15 else if curchr=
26655 then n:=32768 else if curchr=26399 then n:=32767 else if curchr=
27485 then n:=16777215 else n:=255{:1233};p:=curchr;scancharnum;
...
then;if filelineerrorstylep then printfileline else printnl(262);
print(1234);end;printint(curval);
if p<27485 then print(1235)else print(1236);printint(n);
begin helpptr:=1;helpline[0]:=1237;end;error;curval:=0;end;
...
{:1232}{1234:}86:begin p:=curchr;scanfourbitint;p:=p+curval;
...
interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(695);
end;printesc(549);begin helpptr:=2;helpline[1]:=1243;helpline[0]:=1244;
end;error;end;end;{:1241}{1242:}79:alteraux;80:alterprevgraf;
...
{:1248}{1252:}99:if curchr=1 then begin ifdef('INITEX')if iniversion
...
{:1264}others:confusion(1197)end;
...
end{:1280}else{1283:}begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(335);
end;print(s);
if eqtb[25066].hh.rh<>-268435455 then useerrhelp:=true else if
longhelpseen then begin helpptr:=1;helpline[0]:=1264;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=1265;helpline[2]:=1266;helpline[1]:=1267;
helpline[0]:=1268;end;end;error;useerrhelp:=false;end{:1283};
...
p:=mem[defref].hh.rh;while p<>-268435455 do begin{1289:}t:=mem[p].hh.lh;
...
printnl(1286);printint(curval);printchar(61);
if eqtb[25323+curval].hh.rh=-268435455 then print(415)else showbox(eqtb[
25323+curval].hh.rh);end{:1296};0:{1294:}begin gettoken;
if interaction=3 then;printnl(1280);
if curcs<>0 then begin sprintcs(curcs);printchar(61);end;printmeaning;
goto 50;end{:1294};others:{1297:}begin p:=thetoks;if interaction=3 then;
printnl(1280);tokenshow(memtop-3);flushlist(mem[memtop-3].hh.rh);
goto 50;end{:1297}end;{1298:}enddiagnostic(true);
begin if interaction=3 then;
...
print(1288);selector:=19;end{:1298};
50:if interaction<3 then begin helpptr:=0;decr(errorcount);
end else if eqtb[27196].int>0 then begin begin helpptr:=3;
helpline[2]:=1275;helpline[1]:=1276;helpline[0]:=1277;end;
end else begin begin helpptr:=5;helpline[4]:=1275;helpline[3]:=1276;
helpline[2]:=1277;helpline[1]:=1278;helpline[0]:=1279;end;end;error;end;
...
end;begin helpptr:=1;helpline[0]:=1291;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end{:1304};
{1328:}selector:=21;print(1307);print(jobname);printchar(32);
...
begin if poolptr+1>poolsize then overflow(257,poolsize-initpoolptr);end;
formatident:=makestring;packjobname(799);
while not wopenout(fmtfile)do promptfilename(1308,799);printnl(1309);
slowprint(wmakenamestring(fmtfile));begin decr(strptr);
poolptr:=strstart[strptr];end;printnl(335);
slowprint(formatident){:1328};{1307:}dumpint(1462916184);
...
dumpthings(formatengine[0],x);libcfree(formatengine);dumpint(486229715);
{1386:}dumpthings(xord[0],256);dumpthings(xchr[0],256);
dumpthings(xprn[0],256);{:1386};dumpint(268435455);dumpint(hashhigh);
dumpint(membot);dumpint(memtop);dumpint(28017);dumpint(8501);
dumpint(607){:1307};{1403:}dumpint(1296847960);
...
dumpthings(mubytecswrite[0],128);end;{:1412};{1309:}dumpint(poolptr);
dumpint(strptr);dumpthings(strstart[0],strptr+1);
dumpthings(strpool[0],poolptr);println;printint(strptr);print(1292);
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1293);
printint(varused);printchar(38);printint(dynused){:1311};
...
until k=27167{:1315};{1316:}repeat j:=k;
...
println;printint(cscount);print(1294){:1318}{:1313};
{1320:}dumpint(fmemptr);dumpthings(fontinfo[0],fmemptr);
dumpint(fontptr);{1322:}begin dumpthings(fontcheck[0],fontptr+1);
...
for k:=0 to fontptr do begin printnl(1298);printesc(hash[15525+k].rh);
printchar(61);printfilename(fontname[k],fontarea[k],335);
if fontsize[k]<>fontdsize[k]then begin print(756);
printscaled(fontsize[k]);print(402);end;end;end{:1322};println;
printint(fmemptr-7);print(1295);printint(fontptr-0);
if fontptr<>1 then print(1296)else print(1297){:1320};
{1324:}dumpint(hyphcount);if hyphnext<=607 then hyphnext:=hyphsize;
dumpint(hyphnext);
...
printint(hyphcount);if hyphcount<>1 then print(1299)else print(1300);
...
dumpthings(hyfnext[1],trieopptr);printnl(1301);printint(triemax);
print(1302);printint(trieopptr);
if trieopptr<>1 then print(1303)else print(1304);print(1305);
printint(trieopsize);
for k:=255 downto 0 do if trieused[k]>0 then begin printnl(815);
printint(trieused[k]);print(1306);printint(k);dumpint(k);
dumpint(trieused[k]);end{:1324};{1326:}dumpint(interaction);
dumpint(formatident);dumpint(69069);eqtb[27198].int:=0{:1326};
{1329:}wclose(fmtfile){:1329};end;
endif('INITEX'){:1302}{1348:}{1349:}procedure newwhatsit(s:smallnumber;
...
end;{:1349}{1350:}procedure newwritewhatsit(w:smallnumber);
...
{:1350}procedure doextension;var k:integer;p:halfword;
...
mem[curlist.tailfield+1].hh.rh:=-268435455;end{:1353};
3:{1354:}begin newwhatsit(3,2);
...
writenoexpanding:=false;end{:1354};4:{1375:}begin getxtoken;
...
mem[curlist.tailfield+1].hh.b1:=normmin(eqtb[27219].int);end{:1377};
others:confusion(1326)end;end;{:1348}{1376:}procedure fixlanguage;
var l:ASCIIcode;
...
{:1376}{1414:}procedure insertsrcspecial;var toklist,p,q:halfword;
...
remembersourceinfo(sourcefilenamestack[inopen],line);end;end;
{:1414}{1068:}procedure handlerightbrace;var p,q:halfword;d:scaled;
f:integer;begin case curgroup of 1:unsave;
0:begin begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(1062);
end;begin helpptr:=2;helpline[1]:=1063;helpline[0]:=1064;end;error;end;
14,15,16:extrarightbrace;{1085:}2:package(0);
...
8:{1026:}begin if(curinput.locfield<>-268435455)or((curinput.indexfield
<>6)and(curinput.indexfield<>3))then{1027:}begin begin if interaction=3
then;if filelineerrorstylep then printfileline else printnl(262);
print(1029);end;begin helpptr:=2;helpline[1]:=1030;helpline[0]:=1031;
end;error;repeat gettoken;until curinput.locfield=-268435455;end{:1027};
endtokenlist;endgraf;unsave;outputactive:=false;insertpenalties:=0;
{1028:}if eqtb[25578].hh.rh<>-268435455 then begin begin if interaction=
3 then;if filelineerrorstylep then printfileline else printnl(262);
print(1032);end;printesc(414);printint(255);begin helpptr:=3;
helpline[2]:=1033;helpline[1]:=1034;helpline[0]:=1035;end;boxerror(255);
end{:1028};
...
buildpage;end{:1026};{:1100}{1118:}10:builddiscretionary;
{:1118}{1132:}6:begin backinput;curtok:=19610;
begin if interaction=3 then;
if filelineerrorstylep then printfileline else printnl(262);print(640);
end;printesc(918);print(641);begin helpptr:=1;helpline[0]:=1143;end;
inserror;end;{:1132}{1133:}7:begin endgraf;unsave;alignpeek;end;
...
end{:1187};end;{:1186}others:confusion(1065)end;end;
...
endif('TEXMF_DEBUG')if eqtb[27203].int>0 then showcurcmdchr{:1031};
...
{:1150}{1154:}214,215,271:setmathchar(eqtb[26655+curchr].hh.rh);
...
70:{1034:}if((curlist.headfield=curlist.tailfield)and(curlist.modefield>
...
curl:=256;goto 111;
80:{1035:}if curl<256 then begin if mem[curq].hh.rh>-268435455 then if
...
90:{1036:}if ligstack=-268435455 then goto 21;curq:=curlist.tailfield;
...
maink:=maink+mainj.b0+1;end;goto 111{:1039};
...
:=bchar else curr:=mem[ligstack].hh.b1;goto 110{:1037}{:1034};
120:{1041:}if eqtb[24539].hh.rh=membot then begin{1042:}begin mainp:=
...
mem[mainp+2].int:=fontinfo[maink+1].int;
mem[mainp+3].int:=fontinfo[maink+2].int;
fontglue[eqtb[25579].hh.rh]:=mainp;end;end{:1042};
...
dummyxprn:ASCIIcode;
begin{1308:}ifdef('INITEX')if iniversion then begin libcfree(fontinfo);
...
if eightbitp then for k:=0 to 255 do xprn[k]:=1;end;{:1387};
...
if x<>8501 then goto 6666;undumpint(x);if x<>607 then goto 6666{:1308};
...
{:1413};{1310:}begin undumpint(x);if x<0 then goto 6666;
...
q:=rover;repeat undumpthings(mem[p],q+2-p);
...
if hashhigh>0 then undumpthings(eqtb[28018],hashhigh);{:1317};
...
{1323:}begin fontcheck:=xmallocarray(fourquarters,fontmax);
...
ifdef('INITEX')trienotready:=false endif('INITEX'){:1325};
{1327:}begin undumpint(x);
...
{:1378};eqtb[27216].int:=-1;
ifdef('STAT')if eqtb[27198].int>0 then{1334:}if logopened then begin
writeln(logfile,' ');
...
savesize:1,'s');end{:1334};endif('STAT');
...
if totalpages=0 then printnl(855)else if curs<>-2 then begin begin
...
fontptr);decr(fontptr);end{:643};begin dvibuf[dviptr]:=249;incr(dviptr);
...
if dviptr>(2147483647-dvioffset)then begin curs:=-2;fatalerror(844);end;
if dviptr>0 then writedvi(0,dviptr-1){:599};printnl(856);
printfilename(0,outputfilename,0);print(284);printint(totalpages);
if totalpages<>1 then print(857)else print(858);print(859);
printint(dvioffset+dviptr);print(860);bclose(dvifile);end{:642};
if logopened then begin writeln(logfile);aclose(logfile);
selector:=selector-2;if selector=17 then begin printnl(1310);
...
begin c:=curchr;if c<>1 then eqtb[27216].int:=-1;
if jobname=0 then openlogfile;
while inputptr>0 do if curinput.statefield=0 then endtokenlist else
endfilereading;while openparens>0 do begin print(1311);decr(openparens);
end;if curlevel>1 then begin printnl(40);printesc(1312);print(1313);
printint(curlevel-1);printchar(41);end;
while condptr<>-268435455 do begin printnl(40);printesc(1312);
print(1314);printcmdchr(105,curif);if ifline<>0 then begin print(1315);
printint(ifline);end;print(1316);ifline:=mem[condptr+1].int;
...
then begin selector:=17;printnl(1317);selector:=19;end;
...
goto 10;end;endif('INITEX')printnl(1318);goto 10;end;10:end;
{:1335}{1336:}ifdef('INITEX')procedure initprim;
...
partoken:=4095+parloc;{:334}{376:}primitive(644,104,0);
primitive(645,104,1);{:376}{384:}primitive(646,110,0);
primitive(647,110,1);primitive(648,110,2);primitive(649,110,3);
primitive(650,110,4);{:384}{411:}primitive(488,89,0);
primitive(512,89,1);primitive(400,89,2);primitive(401,89,3);
{:411}{416:}primitive(683,79,102);primitive(684,79,1);
...
primitive(694,70,4);{:416}{468:}primitive(750,108,0);
primitive(751,108,1);primitive(752,108,2);primitive(753,108,3);
primitive(754,108,4);primitive(755,108,5);
{:468}{487:}primitive(772,105,0);primitive(773,105,1);
primitive(774,105,2);primitive(775,105,3);primitive(776,105,4);
primitive(777,105,5);primitive(778,105,6);primitive(779,105,7);
primitive(780,105,8);primitive(781,105,9);primitive(782,105,10);
primitive(783,105,11);primitive(784,105,12);primitive(785,105,13);
primitive(786,105,14);primitive(787,105,15);primitive(788,105,16);
{:487}{491:}primitive(789,106,2);hash[15518].rh:=789;
eqtb[15518]:=eqtb[curval];primitive(790,106,4);primitive(791,106,3);
{:491}{553:}primitive(816,87,0);hash[15525].rh:=816;
eqtb[15525]:=eqtb[curval];{:553}{780:}primitive(917,4,256);
primitive(918,5,257);hash[15515].rh:=918;eqtb[15515]:=eqtb[curval];
primitive(919,5,258);hash[15519].rh:=920;hash[15520].rh:=920;
eqtb[15520].hh.b0:=9;eqtb[15520].hh.rh:=memtop-11;eqtb[15520].hh.b1:=1;
eqtb[15519]:=eqtb[15520];eqtb[15519].hh.b0:=115;
{:780}{983:}primitive(989,81,0);primitive(990,81,1);primitive(991,81,2);
primitive(992,81,3);primitive(993,81,4);primitive(994,81,5);
primitive(995,81,6);primitive(996,81,7);
{:983}{1052:}primitive(1043,14,0);primitive(1044,14,1);
{:1052}{1058:}primitive(1045,26,4);primitive(1046,26,0);
primitive(1047,26,1);primitive(1048,26,2);primitive(1049,26,3);
primitive(1050,27,4);primitive(1051,27,0);primitive(1052,27,1);
primitive(1053,27,2);primitive(1054,27,3);primitive(333,28,5);
primitive(337,29,1);primitive(339,30,99);
{:1058}{1071:}primitive(1072,21,1);primitive(1073,21,0);
primitive(1074,22,1);primitive(1075,22,0);primitive(414,20,0);
primitive(1076,20,1);primitive(1077,20,2);primitive(984,20,3);
primitive(1078,20,4);primitive(986,20,5);primitive(1079,20,106);
primitive(1080,31,99);primitive(1081,31,100);primitive(1082,31,101);
primitive(1083,31,102);{:1071}{1088:}primitive(1098,43,1);
primitive(1099,43,0);{:1088}{1107:}primitive(1108,25,12);
primitive(1109,25,11);primitive(1110,25,10);primitive(1111,23,0);
primitive(1112,23,1);primitive(1113,24,0);primitive(1114,24,1);
{:1107}{1114:}primitive(45,47,1);primitive(346,47,0);
{:1114}{1141:}primitive(1146,48,0);primitive(1147,48,1);
{:1141}{1156:}primitive(885,50,16);primitive(886,50,17);
primitive(887,50,18);primitive(888,50,19);primitive(889,50,20);
primitive(890,50,21);primitive(891,50,22);primitive(892,50,23);
primitive(894,50,26);primitive(893,50,27);primitive(1148,51,0);
primitive(897,51,1);primitive(898,51,2);
{:1156}{1169:}primitive(880,53,0);primitive(881,53,2);
primitive(882,53,4);primitive(883,53,6);
{:1169}{1178:}primitive(1166,52,0);primitive(1167,52,1);
primitive(1168,52,2);primitive(1169,52,3);primitive(1170,52,4);
primitive(1171,52,5);{:1178}{1188:}primitive(895,49,30);
primitive(896,49,31);hash[15517].rh:=896;eqtb[15517]:=eqtb[curval];
{:1188}{1208:}primitive(1190,93,1);primitive(1191,93,2);
primitive(1192,93,4);primitive(1193,97,0);primitive(1194,97,1);
primitive(1195,97,2);primitive(1196,97,3);
{:1208}{1219:}primitive(1210,94,0);primitive(1211,94,1);
if enctexp then begin primitive(1212,94,10);primitive(1213,94,11);end;
{:1219}{1222:}primitive(1219,95,0);primitive(1220,95,1);
primitive(1221,95,2);primitive(1222,95,3);primitive(1223,95,4);
primitive(1224,95,5);primitive(1225,95,6);
if mltexp then begin primitive(1226,95,7);end;
{:1222}{1230:}primitive(420,85,25631);
if enctexp then begin primitive(1231,85,25580);primitive(1232,85,25581);
primitive(1233,85,25582);end;primitive(424,85,26655);
...
primitive(419,86,25615);{:1230}{1250:}primitive(960,99,0);
primitive(972,99,1);{:1250}{1254:}primitive(1249,78,0);
primitive(1250,78,1);{:1254}{1262:}primitive(272,100,0);
primitive(273,100,1);primitive(274,100,2);primitive(1259,100,3);
{:1262}{1272:}primitive(1260,60,1);primitive(1261,60,0);
{:1272}{1277:}primitive(1262,58,0);primitive(1263,58,1);
{:1277}{1286:}primitive(1269,57,25887);primitive(1270,57,26143);
{:1286}{1291:}primitive(1271,19,0);primitive(1272,19,1);
primitive(1273,19,2);primitive(1274,19,3);
{:1291}{1344:}primitive(1320,59,0);primitive(606,59,1);writeloc:=curval;
primitive(1321,59,2);primitive(1322,59,3);hash[15524].rh:=1322;
eqtb[15524]:=eqtb[curval];primitive(1323,59,4);primitive(1324,59,5);
{:1344};nonewcontrolsequence:=true;end;
endif('INITEX'){:1336}{1338:}ifdef('TEXMF_DEBUG')procedure debughelp;
label 888,10;var k,l,m,n:integer;begin;while true do begin;
printnl(1319);fflush(stdout);read(stdin,m);
...
endif('TEXMF_DEBUG'){:1338}{:1330}{1332:}procedure mainbody;
...
{:290}{522:}if formatdefaultlength>maxint then bad:=31;
{:522}{1249:}if 2*268435455<memtop-memmin then bad:=41;
{:1249}if bad>0 then begin writeln(stdout,
...
write(stdout,'This is TeXk, Version 3.141592653')else write(stdout,
'This is TeX, Version 3.141592653');write(stdout,versionstring);
...
{1337:}begin{331:}begin inputptr:=0;maxinstack:=0;
...
buffer[0]:=0;scannerstatus:=0;warningindex:=-268435455;first:=1;
...
fontname[0]:=816;fontarea[0]:=335;hyphenchar[0]:=45;skewchar[0]:=-1;
...
{765:}magicoffset:=strstart[911]-9*16{:765};
{75:}if interaction=0 then selector:=16 else selector:=17{:75};
...
readyalready:=0;if(history<>0)and(history<>1)then uexit(1)else uexit(0);
end;end;{:1332}{1392:}procedure scanfilenamebraced;
...
{:1392}{1415:}function getnullstr:strnumber;begin getnullstr:=335;end;
{:1415}
