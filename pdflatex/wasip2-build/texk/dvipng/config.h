...
/* Define to 1 if you have the 'kpse_program_basename' function. */
/* #undef HAVE_KPSE_PROGRAM_BASENAME */
...
/* Name of package */
#define PACKAGE "dvipng--tex-live-"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "tex-k@tug.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dvipng (TeX Live)"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dvipng (TeX Live) 1.18"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dvipng--tex-live-"
