...
fixdateandtime ( void ) 
{
  ...
  eqtb [27187 ].cint = systime ;
  eqtb [27188 ].cint = sysday ;
  eqtb [27189 ].cint = sysmonth ;
  eqtb [27190 ].cint = sysyear ;
} 
void 
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    Fputs ( logfile ,  "This is TeXk, Version 3.141592653" ) ;
    else
    Fputs ( logfile ,  "This is TeX, Version 3.141592653" ) ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1343 , 804 ) ;
	  writeopen [j ]= true ;
...
zshipout ( halfword p ) 
{
  ...
  if ( outputfilename == 0 ) 
  {
    ...
    openlogfile () ;
    packjobname ( 808 ) ;
    while ( ! bopenout ( dvifile ) ) promptfilename ( 809 , 808 ) ;
