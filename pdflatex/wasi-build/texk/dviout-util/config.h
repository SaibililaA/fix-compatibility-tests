...
/* Name of package */
#define PACKAGE "dviout-util--tex-live-"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "tex-k@tug.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dviout-util (TeX Live)"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dviout-util (TeX Live) 20240427"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dviout-util--tex-live-"
