...
initialize ( void ) 
{
  ...
  if ( iniversion ) 
  {
    ...
    trieopptr = 0 ;
    trienotready = true ;
    hash [15514 ].v.RH = 1209 ;
    if ( iniversion ) 
    formatident = 1289 ;
    hash [15522 ].v.RH = 1331 ;
    eqtb [15522 ].hh.b1 = 1 ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 968 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 969 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 799 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1308 , 799 ) ;
  printnl ( 1309 ) ;
...
initprim ( void ) 
{
  ...
  primitive ( 780 , 105 , 8 ) ;
  primitive ( 781 , 105 , 9 ) ;
  primitive ( 782 , 105 , 10 ) ;
  primitive ( 783 , 105 , 11 ) ;
  primitive ( 784 , 105 , 12 ) ;
  primitive ( 785 , 105 , 13 ) ;
  primitive ( 786 , 105 , 14 ) ;
  primitive ( 787 , 105 , 15 ) ;
  primitive ( 788 , 105 , 16 ) ;
  primitive ( 789 , 106 , 2 ) ;
  hash [15518 ].v.RH = 789 ;
  ...
  primitive ( 1078 , 20 , 4 ) ;
  primitive ( 986 , 20 , 5 ) ;
  primitive ( 1079 , 20 , 106 ) ;
  primitive ( 1080 , 31 , 99 ) ;
  primitive ( 1081 , 31 , 100 ) ;
  primitive ( 1082 , 31 , 101 ) ;
  primitive ( 1083 , 31 , 102 ) ;
  primitive ( 1098 , 43 , 1 ) ;
  primitive ( 1099 , 43 , 0 ) ;
  primitive ( 1108 , 25 , 12 ) ;
  primitive ( 1109 , 25 , 11 ) ;
  primitive ( 1110 , 25 , 10 ) ;
  primitive ( 1111 , 23 , 0 ) ;
  primitive ( 1112 , 23 , 1 ) ;
  primitive ( 1113 , 24 , 0 ) ;
  primitive ( 1114 , 24 , 1 ) ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1212 , 94 , 10 ) ;
    primitive ( 1213 , 94 , 11 ) ;
  } 
  primitive ( 1219 , 95 , 0 ) ;
  primitive ( 1220 , 95 , 1 ) ;
  primitive ( 1221 , 95 , 2 ) ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1231 , 85 , 25580 ) ;
    primitive ( 1232 , 85 , 25581 ) ;
    primitive ( 1233 , 85 , 25582 ) ;
  } 
  ...
  primitive ( 273 , 100 , 1 ) ;
  primitive ( 274 , 100 , 2 ) ;
  primitive ( 1259 , 100 , 3 ) ;
  primitive ( 1260 , 60 , 1 ) ;
  primitive ( 1261 , 60 , 0 ) ;
  primitive ( 1262 , 58 , 0 ) ;
  primitive ( 1263 , 58 , 1 ) ;
  primitive ( 1269 , 57 , 25887 ) ;
  primitive ( 1270 , 57 , 26143 ) ;
  primitive ( 1271 , 19 , 0 ) ;
  primitive ( 1272 , 19 , 1 ) ;
  primitive ( 1273 , 19 , 2 ) ;
  primitive ( 1274 , 19 , 3 ) ;
...
mainbody ( void ) 
{
  ...
  Fputs ( stdout ,  "This is TeXk, Version 3.141592653" ) ;
  else
  Fputs ( stdout ,  "This is TeX, Version 3.141592653" ) ;
